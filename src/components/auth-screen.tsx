...
<dyad-write path="src/app/page.tsx" description="Added a clickable search button (magnifying glass) that triggers the search by updating a dedicated state, ensuring the task list refreshes only when the button is pressed">
"use client";
...
export default function Home() {
  ...
  const [searchTrigger, setSearchTrigger] = useState<number>(0); // increments to trigger search
  ...
  // -------------------------------------------------
  // 5️⃣  Search handling – trigger on button click
  // -------------------------------------------------
  const handleSearch = () => {
    // Increment a counter to force re‑evaluation of filtered tasks
  ...
  // The filtered list now depends on searchTrigger so it updates only after clicking the search button
          ...
          <div className="flex gap-2">
            <div className="relative flex-1 flex items-center">
              ...
              <Button
                ...
                className="ml-2 rounded-full text-slate-500 hover:text-indigo-600"
                aria-label="Buscar"
              >
